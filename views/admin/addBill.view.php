    ...
    <div class="model">
      <div class="general">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-4"><input type="date" name="date" id="date"></div>
          ...
          <div class="col-sm-6 col-md-4 col-lg-4"><input type="text" name="object" id="object"></div>
